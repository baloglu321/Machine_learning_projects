...
def start_streamlit():
    ...
    st.caption(
        "INFO:l In the table above you can see how effectively the lasso model keeps which of the data."
    )
