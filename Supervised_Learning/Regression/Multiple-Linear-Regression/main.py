...
def start_streamlit():
    ...
    with st.spinner("Wait for it..."):
        ...
        low = st.number_input("Insert a lower value",min_value=1.0,value=round(current_low,2))
        high = st.number_input("Insert a higher value",min_value=1.0,value=round(current_high,2))
        open = st.number_input("Insert a open value",min_value=1.0,value=round(current_open,2))
        close = st.number_input("Insert a close value",min_value=1.0,value=round(current_close,2))
